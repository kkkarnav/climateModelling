...
def plot_trends(lats, lons, path="./dataset/heat_main/main_tmax_panel.csv", data_type = "tmax"):
    ...
    for lat in lats:
        ...
        for lon in lons:
            lon_data = lat_data[lat_data['LONG'] == lon]
            relevant_data = lon_data.drop(columns = ['LAT', 'LONG'])
